...
const base = 'https://qtzxly.github.io'
// const tweetUrl = computed(() => `https://twitter.com/intent/tweet?text=${encodeURIComponent(`Reading @antfu7\'s ${base}${route.path}\n\nI think...`)}`)
const tweetUrl = computed(() => `https://qtzxly.github.io?text=${encodeURIComponent(`Reading @qtzxly\'s ${base}${route.path}\n\nI think...`)}`)
const elkUrl = computed(() => `https://qtzxly.github.io?text=${encodeURIComponent(`Reading @qtzxly\'s ${base}${route.path}\n\nI think...`)}`)
